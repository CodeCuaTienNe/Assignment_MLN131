...
export const SlidesContent = ({ scrollToSection }) => {
  return (
    <>
                ...
                <Card style={{ borderRadius: 12, textAlign: "center" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      Phân tích hệ thống quan điểm của Mác-Ăngghen & Lê-nin về
                      gia đình
                    </li>
                    <li style={{ padding: "8px 0" }}>
                      ...
                      Đánh giá quá trình biến đổi của Gia đình Việt Nam trong
                      Thời kỳ quá độ và Đổi mới
                    </li>
                  </ul>
                </Card>
      ...
      {/* SLIDE 3: P1. LÝ LUẬN C. MÁC VÀ PH. ĂNGGHEN (1/2) */}
      <section
        id="slide3"
        style={{
          minHeight: "100vh",
            ...
            <Col xs={24} lg={12}>
              ...
              >
                ...
                <Space direction="vertical" size="medium">
                  ...
                  <Text
                    strong
                    style={{ fontSize: "1.125rem", color: "#d43731" }}
                  >
                    Chế độ Tư hữu:
                  </Text>
                  <Card
